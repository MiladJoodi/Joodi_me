...
const config: Config = {
  title: "This is Joodi",
  tagline: "I'm trying to show simplify the codes",
  ...
  organizationName: 'Joodi', // Usually your GitHub org/user name.
  projectName: 'Joodi', // Usually your repo name.
